export const projectData = [
  ...
  },  
  {
    ...
    description: "A car rental service that allows users to rent cars for a specific period of time.",
    functionality: "This site allows users to view and rent cars listed by other users. A typical CRUD app accompanied by user authentication.",
